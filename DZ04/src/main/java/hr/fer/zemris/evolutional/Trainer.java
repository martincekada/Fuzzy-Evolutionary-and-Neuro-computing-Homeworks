...
public class Trainer {
    ...
    public Unit train(int populationSize, boolean elitism, int elite_size, AbstractCrossover crossover, AbstractSelection selection, AbstractMutation mutation) {
        List<Unit> population = Unit.generatePopulation(populationSize);
